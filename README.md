[![MCP Scorecard: 74/100](https://img.shields.io/badge/proofof.ai-74%2F100-5b21b6)](https://proofof.ai/scorecard/llm-compliance-comparison-mcp.html)

mcp-name: io.github.CSOAI-ORG/llm-compliance-comparison-mcp
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/llm_compliance_comparison_mcp/)
...
```bash
# Install via pip
pip install llm_compliance_comparison_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install llm-compliance-comparison-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/llm-compliance-comparison-mcp)
